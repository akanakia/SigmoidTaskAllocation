...
The objective of the system is to complete all the tasks in the environment while maximizing system utility, $U$, by tuning the available agent-level parameters, $\theta_i$ and $\tau_i)$, i.e. $goal = \amin{\theta_i, \tau_i} U$.
