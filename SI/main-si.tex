...
\edit{While this paper focusses on using theory from global games to explain a commonly used ad-hoc method for task allocation (probabilistic response thresholds), theory of learning for games with imperfect information is still far from maturity. Extending these learning mechanisms for games of imperfect information to learn efficient coordination policies in distributed task-allocation problems is therefore subject of ongoing research in the community. }
