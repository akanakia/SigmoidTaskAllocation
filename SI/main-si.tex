...
Results from this paper assume that the response threshold is constant, which is not necessarily the case in natural systems or swarm robotics \cite{castello2016adaptive}, where adaptive thresholds can improve performance. Formally extending the methods presented here to include adaptive thresholds is subject of further work.
