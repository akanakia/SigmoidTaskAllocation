...
\end{subfigure}
\caption{Left (a): A visual representation of the collaboration experiment being studied. Right (b): The Droplets swarm robotic platform \cite{farrow14,klingner14}.}
\end{figure*}
