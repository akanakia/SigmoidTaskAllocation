...
%
To show that there exists a sensible threshold policy for the class of tasks with concurrent benefits, we will first show that XXX, and then show that YYY.
